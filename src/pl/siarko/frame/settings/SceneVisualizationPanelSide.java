...
public class SceneVisualizationPanelSide extends SceneVisualizationPanel{
    ...
    protected void paintComponent(Graphics g) {
        ...
        clone.sort((o1, o2) -> {
            if(o2.getRenderable() != null && o1.getRenderable() != null){
                return (int) (o1.getRenderable().getCenter().x - o2.getRenderable().getCenter().x);
            }else{
                return 0;
            }
        });
        ...
        for(EnvironmentObject e: clone){
            ...
            p.drawOnSceneSide(g2, isSelected);
        }
